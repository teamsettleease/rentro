...
function ListingsTable({ filters }) {
    ...
    // Close all dialogs
    const closeAllDialogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[closeAllDialogs]": ()=>{
            setDialogs({
                view: false,
                edit: false,
                delete: false,
    ...
    const openDialog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[openDialog]": (type, listing)=>{
            if (isLoading) return;
            setDropdownOpen(null) // Close dropdown first
            ;
            setTimeout({
                "ListingsTable.useCallback[openDialog]": ()=>{
                    setSelectedListing(listing);
                    setDialogs({
                        "ListingsTable.useCallback[openDialog]": (prev)=>({
                                ...prev,
                                [type]: true
                            })
                    }["ListingsTable.useCallback[openDialog]"]);
                }
            }["ListingsTable.useCallback[openDialog]"], 100);
        }
    }["ListingsTable.useCallback[openDialog]"], [
        isLoading
    ]);
    const handleSort = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[handleSort]": (column)=>{
            if (isLoading) return;
    ...
    }["ListingsTable.useCallback[handleSort]"], [
        sortColumn,
        sortDirection,
        isLoading
    ]);
    const toggleSelectAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[toggleSelectAll]": ()=>{
            if (isLoading) return;
            if (selectedRows.length === listings.length) {
                setSelectedRows([]);
            } else {
                setSelectedRows(listings.map({
                    "ListingsTable.useCallback[toggleSelectAll]": (listing)=>listing.id
                }["ListingsTable.useCallback[toggleSelectAll]"]));
            }
        }
    }["ListingsTable.useCallback[toggleSelectAll]"], [
    ...
    const toggleSelectRow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[toggleSelectRow]": (id)=>{
            if (isLoading) return;
            setSelectedRows({
                "ListingsTable.useCallback[toggleSelectRow]": (prev)=>prev.includes(id) ? prev.filter({
                        "ListingsTable.useCallback[toggleSelectRow]": (rowId)=>rowId !== id
                    }["ListingsTable.useCallback[toggleSelectRow]"]) : [
                        ...prev,
                        id
                    ]
            }["ListingsTable.useCallback[toggleSelectRow]"]);
    ...
    const handleAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[handleAction]": async (action, successMessage)=>{
            if (isLoading) return;
            setIsLoading(true);
            try {
                await action();
    ...
    }["ListingsTable.useCallback[handleAction]"], [
        isLoading,
        toast,
        closeAllDialogs
    ]);
    const handleDuplicateListing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[handleDuplicateListing]": (listing, event)=>{
            event?.stopPropagation();
            setDropdownOpen(null);
            handleAction({
                "ListingsTable.useCallback[handleDuplicateListing]": ()=>{
                    // Simulate API call
                    return new Promise({
                        "ListingsTable.useCallback[handleDuplicateListing]": (resolve)=>setTimeout(resolve, 500)
                    }["ListingsTable.useCallback[handleDuplicateListing]"]);
                }
            }["ListingsTable.useCallback[handleDuplicateListing]"], `"${listing.title}" has been duplicated successfully.`);
        }
    }["ListingsTable.useCallback[handleDuplicateListing]"], [
        handleAction
    ]);
    const handleToggleStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[handleToggleStatus]": (listing, event)=>{
            event?.stopPropagation();
            setDropdownOpen(null);
            const newStatus = listing.status === "Active" ? "Inactive" : "Active";
            handleAction({
                "ListingsTable.useCallback[handleToggleStatus]": ()=>{
                    // Simulate API call
                    return new Promise({
                        "ListingsTable.useCallback[handleToggleStatus]": (resolve)=>setTimeout(resolve, 500)
                    }["ListingsTable.useCallback[handleToggleStatus]"]);
                }
            }["ListingsTable.useCallback[handleToggleStatus]"], `"${listing.title}" is now ${newStatus}.`);
        }
    }["ListingsTable.useCallback[handleToggleStatus]"], [
        handleAction
    ]);
    const handleViewOnMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[handleViewOnMap]": (listing, event)=>{
            event?.stopPropagation();
            setDropdownOpen(null);
            handleAction({
                "ListingsTable.useCallback[handleViewOnMap]": ()=>{
                    // Simulate opening map
                    window.open(`https://maps.google.com/?q=${encodeURIComponent(listing.location)}`, "_blank");
                }
            }["ListingsTable.useCallback[handleViewOnMap]"], `Opening "${listing.title}" on map.`);
        }
    }["ListingsTable.useCallback[handleViewOnMap]"], [
        handleAction
    ]);
    const handleFeatureListing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[handleFeatureListing]": (listing, event)=>{
            event?.stopPropagation();
            setDropdownOpen(null);
            handleAction({
                "ListingsTable.useCallback[handleFeatureListing]": ()=>{
                    // Simulate API call
                    return new Promise({
                        "ListingsTable.useCallback[handleFeatureListing]": (resolve)=>setTimeout(resolve, 500)
                    }["ListingsTable.useCallback[handleFeatureListing]"]);
                }
            }["ListingsTable.useCallback[handleFeatureListing]"], `"${listing.title}" has been featured.`);
        }
    }["ListingsTable.useCallback[handleFeatureListing]"], [
        handleAction
    ]);
    const handleBulkExport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[handleBulkExport]": ()=>{
            if (isLoading || selectedRows.length === 0) return;
            handleAction({
                "ListingsTable.useCallback[handleBulkExport]": ()=>{
                    const selectedListings = listings.filter({
                        "ListingsTable.useCallback[handleBulkExport].selectedListings": (listing)=>selectedRows.includes(listing.id)
                    }["ListingsTable.useCallback[handleBulkExport].selectedListings"]);
            ...
            }["ListingsTable.useCallback[handleBulkExport]"], `${selectedRows.length} listings exported successfully.`);
        }
    }["ListingsTable.useCallback[handleBulkExport]"], [
        selectedRows,
        handleAction,
    ...
    const confirmDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[confirmDelete]": ()=>{
            handleAction({
                "ListingsTable.useCallback[confirmDelete]": ()=>{
                    // Simulate API call
                    return new Promise({
                        "ListingsTable.useCallback[confirmDelete]": (resolve)=>setTimeout(resolve, 500)
                    }["ListingsTable.useCallback[confirmDelete]"]);
                }
            }["ListingsTable.useCallback[confirmDelete]"], `"${selectedListing?.title}" has been deleted.`);
        }
    }["ListingsTable.useCallback[confirmDelete]"], [
        selectedListing,
        handleAction
    ...
    const saveEdit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[saveEdit]": ()=>{
            handleAction({
                "ListingsTable.useCallback[saveEdit]": ()=>{
                    // Simulate API call
                    return new Promise({
                        "ListingsTable.useCallback[saveEdit]": (resolve)=>setTimeout(resolve, 500)
                    }["ListingsTable.useCallback[saveEdit]"]);
                }
            }["ListingsTable.useCallback[saveEdit]"], `"${selectedListing?.title}" has been updated successfully.`);
        }
    }["ListingsTable.useCallback[saveEdit]"], [
        selectedListing,
        handleAction
    ]);
    const copyShareLink = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListingsTable.useCallback[copyShareLink]": ()=>{
            if (!selectedListing) return;
            handleAction({
                "ListingsTable.useCallback[copyShareLink]": ()=>{
                    navigator.clipboard.writeText(`https://rentro.com/listing/${selectedListing.id}`);
                }
            }["ListingsTable.useCallback[copyShareLink]"], "Listing link copied to clipboard.");
        }
    }["ListingsTable.useCallback[copyShareLink]"], [
        selectedListing,
        handleAction
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dialog"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                    ...
                    children: [
                        ...
                        selectedListing && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-4",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ListingsTable, "mVTRbuSV4I3KpxnYno4KH2RG8vI=", false, function() {
    return [
...
"[project]/src/components/admin-dashboard/listings-map.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: filteredListings.map((listing)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ListingsMap, "tkfirIy2wkUHhyA0sBcGp7hostg=");
_c = ListingsMap;
var _c;
__turbopack_context__.k.register(_c, "ListingsMap");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_894bc5d6._.js.map
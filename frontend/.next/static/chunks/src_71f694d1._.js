...
(()=>{
    const e = new Error("Cannot find module '@/components/ban-user-dialog'");
...
function UsersTable({ filters, userType }) {
    ...
    // In a real app, you would apply additional filters here
...
_s(UsersTable, "YJWIDvshBQD1+egwlLIrfKCiErQ=", false, function() {
    return [
        useToast
    ];
});
...
//# sourceMappingURL=src_71f694d1._.js.map